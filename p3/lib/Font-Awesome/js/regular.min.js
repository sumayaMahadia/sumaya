...
!function() {
    ...
    var z = c, a = l, L = (z.document, !a.documentElement || !a.head || "function" != typeof a.addEventListener || a.createElement, 
    ~s.indexOf("MSIE") || s.indexOf("Trident/"), "classic"), M = {
        fak: "kit",
        "fa-kit": "kit"
    }, e = {
        fakd: "kit-duotone",
    ...
    const h = z || {};
    h[a] || (h[a] = {}), h[a].styles || (h[a].styles = {}), h[a].hooks || (h[a].hooks = {}), 
    h[a].shims || (h[a].shims = []);
    var g = h[a];
    function A(z) {
    ...
    function p(c, l, s) {
        var {
            skipHooks: z = !1
        } = 2 < arguments.length && void 0 !== s ? s : {}, s = A(l);
        "function" != typeof g.hooks.addPack || z ? g.styles[c] = {
            ...g.styles[c] || {},
            ...s
        } : g.hooks.addPack(c, A(l)), "fas" === c && p("fa", l);
    }
    var k = {
